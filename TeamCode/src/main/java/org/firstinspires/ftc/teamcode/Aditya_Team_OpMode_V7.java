...
@TeleOp(name = "Aditya_Team V7", group = "Team")
// @Disabled
public class Aditya_Team_OpMode_V7 extends LinearOpMode {
    ...
    private void runAutonomous() {
        ...
        for (int b = 0; b < 8; b++) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                leftDriveControl = 0.15;
                rightDriveControl = 0.15;
                setDrives();
            }
