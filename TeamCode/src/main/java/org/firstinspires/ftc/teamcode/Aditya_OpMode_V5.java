...
@TeleOp(name = "Aditya V5", group = "Team")
// @Disabled
public class Aditya_OpMode_V5 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        theBeacon.init(robot.hwMap, "Beacon");
        theBeacon.rgb(255,0,0);
